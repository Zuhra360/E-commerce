import footerlogo from "../../../../src/assets/images/Home/footerlogo.png";
import twitter from "../../../../src/assets/images/Home/Twitter.png";
import facebook from "../../../../src/assets/images/Home/Facebook.png";
import tiktok from "../../../../src/assets/images/Home/Tiktok.png";
import instagram from "../../../../src/assets/images/Home/Instagram.png";

export const Footer = () => {
  return (
    <div className="md:w-full md:h-[504px] w-[375px] h-[815px] md:py-0 md:px-0 py-[48px] px-[32px] md:gap-0 gap-[32px] bg-black flex items-center justify-center flex-col ">
