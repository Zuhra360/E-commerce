import banner2bg from "../../../../src/assets/images/Home/banner2bg.png";
import banner2bg2 from "../../../../src/assets/images/Home/banner2bg2.png";

export const Banner2 = () => {
  return (
    <div className="md:w-full md:h-[448px] w-[375px] h-[512px] md:px-0 md:py-0 py-[104px] px-[16px] bg-no-repeat overflow-hidden flex items-center justify-center"
