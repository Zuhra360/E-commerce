...
export const ProductsPage = () => {
  ...
  return (
    <div className='w-full h-auto'>
        ...
        <div className=" md:w-full w-[375px] h-auto md:h-[1560px] md:px-[160px] md:pt-[24px] md:pb-[56px] md:flex md:gap-[32px] ">
            ...
            <div className="md:w-[1119px] w-full h-auto md:h-[1480px] md:flex md:flex-row md:gap-[32px] ">
                ...
                <div className="md:w-[831px] w-[375px] h-auto md:h-[1480px] flex flex-col md:gap-[14px]">
                    <Box className="w-full md:h-[1408px] h-auto flex flex-col gap-[24px] ">
                        ...
                        <h1 className="block md:hidden md:w-[200px] md:h-[16px] md:text-[#6C6C6C] md:text-[16px] md:font-medium md:font-['Inter'] md:leading-[16px]">Product Results: <span className="text-gray-300">85</span></h1>

                        <div className="md:w-full w-[344px] md:h-[1344px] h-[1571px] gap-[24px] grid md:grid-rows-3  md:grid-cols-3 grid-rows-4 grid-cols-2">
                ...
                {isFilterOpen && (
                <div className="absolute top-20 bg-white left-0 block md:hidden md:w-[256px] w-[374px] h-auto md:h-[1480px] md:max-w-[256px] ">
