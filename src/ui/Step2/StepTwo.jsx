...
export const StepTwo = () => {
  ...
  return (
    <div className='md:w-full md:h-[688px] w-[375px] h-[816px]  py-[48px] md:px-[160px] px-[16px] flex flex-col  md:gap-[64px] gap-[40px]'>
      <div className='md:w-[1120px] md:h-[592px] md:flex md:justify-between md:flex-col md:gap-0 gap-[40px] '>
        <Box className='md:w-full w-[343px] md:h-[304px] h-[616px] flex flex-col gap-[32px] '>
