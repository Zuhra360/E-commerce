  ...
  return (
    <div className='w-full h-auto md:h-[880px]  md:py-[112px] md:px-[160px] md:flex  md:gap-[48px]'>
      <div className='md:w-[1120] md:h-[656px] w-full h-auto  flex md:flex-row flex-col p-[10px] md:p-0 md:gap-[48px] gap-[16px]'>
        <Box className='md:w-[536px] md:h-[556px] w-[341px] h-[656px] flex flex-col gap-[40px]'>
            ...
            <div className='w-full md:h-[492px] h-[592px] rounded-[15px] flex flex-col gap-[40px] '>
              {CartData1.map((data,index) =>
                <div key={index} className='w-full md:h-[138px] h-[152px]  md:pt-[16px] md:pb-[32px] py-[16px]  flex flex-row  gap-[15px] border-b-[0.5px] border-[#A3A3A3] '>
        ...
        <Box className='md:w-[536px] w-[341px] h-[656px]  py-[56px] md:px-[64px] px-[16px] flex flex-col rounded-[10px] gap-[40px] border-[1px] border-[#A3A3A3]'>
