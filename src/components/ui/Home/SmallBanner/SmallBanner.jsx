...
import headphone from "../../../../assets/images/Home/airpodimg.png";
import Applevision from "../../../../assets/images/Home/Applevision.png";
...
export const SmallBanner = () => {
  return (
    <div className="w-full h-auto  flex md:flex-row flex-col">
        <div className="md:w-1/2 w-full md:h-[600px]  flex md:flex-col flex-col-reverse">
           <div className="md:w-full md:h-[328px] w-full h-[424px] md:px-0 md:py-0 py-[40px] px-[16px] bg-white flex md:flex-row flex-col gap-[24px] md:gap-0 items-center overflow-hidden">
            ...
            <div className="md:w-full md:h-[272px] h-auto flex md:flex-row flex-col">
                <div className="md:w-1/2 md:h-full w-full h-[376px] md:pr-[48px] md:py-0 py-[40px] md:pl-0 px-[16px] md:gap-0 gap-[24px] flex md:flex-row flex-col items-center bg-[#ececec] overflow-hidden">
                ...
                <div className="md:w-1/2 md:h-full w-full h-[376px] md:pr-[48px] md:py-0 py-[40px] md:pl-0 px-[16px] md:gap-0 gap-[24px] flex md:flex-row flex-col items-center bg-[#353535]">
        ...
        <div className="md:w-1/2 md:h-[600px] w-full h-[504px] bg-[#EDEDED] md:py-[44px] md:pr-0 py-[40px] px-[16px] md:pl-[56px] md:gap-[1px] gap-[24px] flex items-center md:flex-row flex-col flex-col-reverse">
