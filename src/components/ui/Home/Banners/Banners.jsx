...
export const Banners = () => {
  return (
    <div className="w-full md:h-[640px] h-[723px] md:py-0 md:px-0 md:gap-0 py-[56px] px-[32px] gap-[48px] flex md:flex-row  ">
        ...
        <Box className="md:w-1/4  md:h-full w-full h-[555px] md:px-[32px] md:py-[20px] bg-white  md:bg-[#F9F9F9] px-[3px] py-[20px] flex items-center flex-col md:gap-2 gap-[16px]">
