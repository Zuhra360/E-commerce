...
export const DiscountProduct = () => {
  ...
  return (
    <div className="w-full md:h-[656px]  h-[896px]  md:py-[80px] md:px-[160px] py-[56px] px-[16px] flex flex-col gap-[32px] items-center">
       <div className="md:w-[1120px] w-[248px] h-[32px]">
          <h1 className=" w-[248px] h-[32px] text-black text-center text-[24px] font-medium font-['Inter'] leading-[32px]">Discounts up to -50%</h1>
       </div>
