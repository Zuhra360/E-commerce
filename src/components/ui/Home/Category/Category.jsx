...
import arrowleft from "../../../../assets/images/Home/Arrowleft.png";
import arrowright from "../../../../assets/images/Home/Arrowright.png";
import phones from "../../../../assets/images/Home/Phones.png";
import smartwatches from "../../../../assets/images/Home/Smart Watches.png";
import cameras from "../../../../assets/images/Home/Cameras.png";
import headphones from "../../../../assets/images/Home/Headphones.png";
import computers from "../../../../assets/images/Home/Computers.png";
import gaming from "../../../../assets/images/Home/Gaming.png";
...
export const Category = () => {
  ...
  return (
    <div className="w-full md:h-[352px] h-[624px] md:py-[80px] md:px-[160px] py-[64px] px-[16px] flex flex-col md:gap-[32px] gap-[48px] ">
