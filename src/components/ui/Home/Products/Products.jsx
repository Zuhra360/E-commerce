...
import iphone14pro from "../../../../assets/images/Home/Iphone14pro.png";
import camera2 from "../../../../assets/images/Home/camera2.png";
import watchimg from "../../../../assets/images/Home/watchimg.png";
import airpodimg from "../../../../assets/images/Home/airpodimg.png";
import gwatchimg from "../../../../assets/images/Home/gwatchimg.png";
import zfoldimg from "../../../../assets/images/Home/zfoldimg.png";
import budsimg from "../../../../assets/images/Home/budsimg.png";
import ipadimg from "../../../../assets/images/Home/ipadimg.png";
...
export const Products = () => {
  ...
  return (
    <div className="w-full md:h-[1056px] h-[1632px] px-[16px] md:px-[160px] py-[56px] flex items-center flex-col gap-[35px] ">
