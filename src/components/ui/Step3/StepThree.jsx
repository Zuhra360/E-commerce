...
import { StepThreeData, StepThreeData2, StepThreeData3, StepThreeData4, StepThreeData5 } from './StepData';
...
export const StepThree = () => {
  ...
  return (
    <div className='md:w-full h-[800px]  pt-[24px] md:px-[160px] px-[16px] pb-[72px] flex items-center justify-center gap-[48px]  md:gap-[96px]'>
