...
import image1 from "../../../assets/images/ProductDetails/Image1.png"
  ...
  return (
    <div className='w-full h-auto'>
        ...
        <div className="w-full md:h-[896px] h-auto  md:py-[112px] md:px-[160px] p-[8px] flex md:flex-row flex-col gap-[48px] ">
            <img src={image1} className="md:w-[536px] w-full md:h-[516px] h-[426px] bg-white"/>

            <div className="md:w-[536px] w-full md:h-[672px] h-[960px] flex flex-col gap-[32px]">
                <Box className="w-full md:h-[496px] h-[648px] flex flex-col gap-[16px]">
                    <div className="w-full md:h-[112px] h-[152px] flex items-center flex-col gap-[24px]">
                        <h1 className="w-full md:h-[40px] h-[80px] font-inter font-bold text-[40px] leading-[40px]">Apple iPhone 14 Pro Max</h1>
                        <div className="w-full h-[48px] flex  justify-center items-center md:justify-start  flex-row gap-[16px] font-inter ">
                    ...
                    <div className="w-full md:h-[368px] h-[480px] flex flex-col gap-[24px] ">
                        <div className="w-full h-[32px] flex  justify-center items-center flex-row gap-[32px] ">
                        ...
                        <div className="w-full h-[48px] flex  justify-center flex-row gap-[16px]">
                        ...
                        <div className="w-full md:h-[144px] h-[208px] flex place-items-center  grid md:grid-cols-3 md:grid-rows-2 grid-cols-2 grid-rows-3 gap-[16px]">
                        ...
                        <div className="w-full  md:h-[56px] h-[120px] flex justify-center flex-row gap-[32px]">
