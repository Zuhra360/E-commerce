...
export const Review = () => {
  return (
    <div className='w-full  md:h-[1336px] h-[2099px] md:py-[88px] py-[40px] md:px-[160px] px-[16px] flex  flex-col rounded-[24px] gap-[32px]'>
      <Box className='md:w-[1120px]  md:h-[384px] h-[596px] flex items-center justify-center flex-col gap-[48px] '>
        ...
        <div className='w-full md:h-[192px] h-[404px] flex md:flex-row flex-col gap-[60px] '>
           ...
           <div className='md:w-[184px] w-full md:h-full h-[152px] flex items-center justify-center md:flex-col flex-row  p-[32px] rounded-[25px] gap-[16px] bg-[#FAFAFA]'>
           ...
           <div className='md:w-[876px]  md:h-[176px] h-[192px] md:min-w-[390px] min-w-[302px] flex items-center flex-col gap-[24px]'>
        ...
        <div className='md:w-[1120px] h-[64px]  py-[24px] px-[16px] flex  flex-col rounded-[7px] border-[0.5px] border-[#CECECE] '>
          <input
          type='text'
          name='comment'
      ...
      <Box className='md:w-[1120px] md:h-[744px] h-[1695px] flex flex-col gap-[24px]'>
      ...
      <div className="md:w-full  h-[48px] flex items-center justify-center">
