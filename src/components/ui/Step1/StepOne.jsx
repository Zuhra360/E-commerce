...
export const StepOne = () => {
  ...
  return (
    <div className='w-full  md:h-[688px] h-[760px] py-[48px] md:px-[160px] px-[16px] flex  gap-[64px]'>
      <div className='md:w-[1120px] md:h-[592px] w-full h-full flex justify-between flex-col md:gap-0 gap-[64px]'>
         <Box className='w-full  md:h-[464px] h-[536px] flex flex-col gap-[32px]'>
             ...
             <div className='w-full md:h-[408px] h-[480px] flex flex-col gap-[48px]'>
                 <div className='w-full md:h-[312px] h-[384px] flex flex-col gap-[24px]'>
                    ...
                    <Box className='md:w-[1120px] w-full h-[48px] flex justify-center items-center flex-col gap-[8px] '>
                       <div className='w-full h-[24px] flex flex-row items-center'>
                          <div class="md:w-[548px] w-1/2 border-t border-dashed border-black"></div>
                          <img src={plus}/>
                          <div class="md:w-[548px] w-1/2 border-t border-dashed border-black"></div>
                       </div>
         ...
         <div className='w-full   h-[64px] flex flex-row justify-end items-center gap-[24px] '>
